...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/orin/code/najib/katauser-fs-lara-vue/public/storage','inertia.ssr.enabled','inertia.ssr.url',
...
'mail.markdown.theme','mail.markdown.paths','multitenancy.tenant_finder','multitenancy.tenant_artisan_search_fields','multitenancy.switch_tenant_tasks',
'multitenancy.tenant_model','multitenancy.queues_are_tenant_aware_by_default','multitenancy.tenant_database_connection_name','multitenancy.landlord_database_connection_name','multitenancy.current_tenant_context_key',
'multitenancy.current_tenant_container_key','multitenancy.shared_routes_cache','multitenancy.actions.make_tenant_current_action','multitenancy.actions.forget_current_tenant_action','multitenancy.actions.make_queue_tenant_aware_action',
'multitenancy.actions.migrate_tenant','multitenancy.queueable_to_job.Illuminate\\Mail\\SendQueuedMailable','multitenancy.queueable_to_job.Illuminate\\Notifications\\SendQueuedNotifications','multitenancy.queueable_to_job.Illuminate\\Queue\\CallQueuedClosure','multitenancy.queueable_to_job.Illuminate\\Events\\CallQueuedListener',
'multitenancy.queueable_to_job.Illuminate\\Broadcasting\\BroadcastEvent','multitenancy.tenant_aware_jobs','multitenancy.not_tenant_aware_jobs','pennant.default','pennant.stores.array.driver',
'pennant.stores.database.driver','pennant.stores.database.connection','pennant.stores.database.table','permission.models.permission','permission.models.role',
...
'session.same_site','session.partitioned','media-library.disk_name','media-library.max_file_size','media-library.queue_connection_name',
...
'media-library.force_lazy_loading','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
