    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Spatie\Multitenancy\Contracts\IsTenant' => \Spatie\Multitenancy\Models\Tenant::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/orin/code/najib/katauser-fs-lara-vue/public/storage' => 'string',
            ...
            'multitenancy.tenant_artisan_search_fields' => 'array',
            'multitenancy.switch_tenant_tasks' => 'array',
            'multitenancy.tenant_model' => 'string',
            'multitenancy.queues_are_tenant_aware_by_default' => 'boolean',
            'multitenancy.tenant_database_connection_name' => 'NULL',
            'multitenancy.landlord_database_connection_name' => 'NULL',
            'multitenancy.current_tenant_context_key' => 'string',
            'multitenancy.current_tenant_container_key' => 'string',
            'multitenancy.shared_routes_cache' => 'boolean',
            'multitenancy.actions.make_tenant_current_action' => 'string',
            'multitenancy.actions.forget_current_tenant_action' => 'string',
            'multitenancy.actions.make_queue_tenant_aware_action' => 'string',
            'multitenancy.actions.migrate_tenant' => 'string',
            'multitenancy.queueable_to_job.Illuminate\Mail\SendQueuedMailable' => 'string',
            'multitenancy.queueable_to_job.Illuminate\Notifications\SendQueuedNotifications' => 'string',
            'multitenancy.queueable_to_job.Illuminate\Queue\CallQueuedClosure' => 'string',
            'multitenancy.queueable_to_job.Illuminate\Events\CallQueuedListener' => 'string',
            'multitenancy.queueable_to_job.Illuminate\Broadcasting\BroadcastEvent' => 'string',
            'multitenancy.tenant_aware_jobs' => 'array',
            'multitenancy.not_tenant_aware_jobs' => 'array',
...
'view.paths','view.compiled','concurrency.default','hashing.driver','hashing.bcrypt.rounds',
...
'analytics.property_id','analytics.service_account_credentials_json','analytics.cache_lifetime_in_minutes','analytics.cache.store','app.name',
...
'filesystems.disks.s3.report','filesystems.links./home/orin/code/najib/katauser-fs-lara-vue/public/storage','inertia.ssr.enabled','inertia.ssr.url','inertia.ensure_pages_exist',
...
'multitenancy.tenant_finder','multitenancy.tenant_artisan_search_fields','multitenancy.switch_tenant_tasks','multitenancy.tenant_model','multitenancy.queues_are_tenant_aware_by_default',
'multitenancy.tenant_database_connection_name','multitenancy.landlord_database_connection_name','multitenancy.current_tenant_context_key','multitenancy.current_tenant_container_key','multitenancy.shared_routes_cache',
'multitenancy.actions.make_tenant_current_action','multitenancy.actions.forget_current_tenant_action','multitenancy.actions.make_queue_tenant_aware_action','multitenancy.actions.migrate_tenant','multitenancy.queueable_to_job.Illuminate\\Mail\\SendQueuedMailable',
'multitenancy.queueable_to_job.Illuminate\\Notifications\\SendQueuedNotifications','multitenancy.queueable_to_job.Illuminate\\Queue\\CallQueuedClosure','multitenancy.queueable_to_job.Illuminate\\Events\\CallQueuedListener','multitenancy.queueable_to_job.Illuminate\\Broadcasting\\BroadcastEvent','multitenancy.tenant_aware_jobs',
'multitenancy.not_tenant_aware_jobs','pennant.default','pennant.stores.array.driver','pennant.stores.database.driver','pennant.stores.database.connection',
...
'permission.enable_wildcard_permission','permission.cache.expiration_time','permission.cache.key','permission.cache.store','query-builder.parameters.include',
...
'query-builder.convert_relation_table_name_strategy','query-builder.convert_field_names_to_snake_case','queue.default','queue.connections.sync.driver','queue.connections.database.driver',
